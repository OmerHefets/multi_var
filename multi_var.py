...
# multi variable linear regression with feature normalization
# since the one_var regression was generalised, no edits were needed except removing the 2D plots
...
def regression(file_name, alpha=0.01, iter=10000):
...
reg_theta = regression('ex1data2.txt')
print(reg_theta)
